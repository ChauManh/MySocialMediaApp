...
function SignUp() {
  ...
  const handleSignUp = async (e) => {
    ...
    if (!form.fullname || !form.username || !form.email || !form.password || !form.verifyPassword) {
    ...
    <div className={cx('wrapper')}>
      ...
      <form onSubmit={handleSignUp} className={cx('formWrapper')}>
        <div className={cx('infoWrapper')}>
          ...
          <Input type="email" name="email" placeholder="Email" onChange={onUpdateField} />
          <Input type="password" name="password" placeholder="Password" onChange={onUpdateField} />
          <Input type="password" name="verifyPassword" placeholder="Verify password" onChange={onUpdateField} />
          <div className={cx('actions')}>
            <span className={cx('terms')}>By signing up, you agree to our terms and conditions</span>
            <Button type="submit" primary className={cx('signUpBtn')}>
              Sign up
            </Button>
            <Link to="/">
              <span className={cx('alreadyHaveAccount')}>Already Have an account?</span>
            </Link>
          </div>
        </div>
      </form>
